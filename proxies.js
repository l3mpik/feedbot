...
var scraper = {
    ...
    parseProxies: function(body) {
        ...
        console.log("Proxies: ", global.get);
    }
}
...
scraper.proxySites = [
    ...
    'http://sslproxies24.blogspot.com/search?max-results=' + scraper.pages,
    'http://proxyserverlist-24.blogspot.com/search?max-results=' + scraper.pages
